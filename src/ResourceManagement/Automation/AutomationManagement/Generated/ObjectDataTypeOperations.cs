...
namespace Microsoft.Azure.Management.Automation
{
    ...
    /// information)
    /// </summary>
    internal partial class ObjectDataTypeOperations : IServiceOperations<AutomationManagementClient>, IObjectDataTypeOperations
    {
        /// <summary>
        ...
        /// </param>
        internal ObjectDataTypeOperations(AutomationManagementClient client)
        {
            this._client = client;
        }
        ...
        /// </returns>
        public async Task<TypeFieldListResponse> ListFieldsByModuleAndTypeAsync(string resourceGroupName, string automationAccount, string moduleName, string typeName, CancellationToken cancellationToken)
        {
            // Validate
            ...
            if (shouldTrace)
            {
                ...
                TracingAdapter.Enter(invocationId, this, "ListFieldsByModuleAndTypeAsync", tracingParameters);
            }
